...
describe('GET /users (auth)', () => {
  ...
  it('returns 403 for non-admin user', async () => {
    mockSql([])
    const res = await app.request('/users', { headers: await authHeaders('user') }, TEST_ENV)
...
describe('GET /users', () => {
  ...
  it('returns list of users', async () => {
    mockSql([[
      { id: 1, username: 'sikander', role: 'admin', created_at: '2026-01-01' },
      { id: 2, username: 'app', role: 'admin', created_at: '2026-01-02' },
    ]])

    const res = await app.request('/users', { headers: await authHeaders('admin') }, TEST_ENV)
...
describe('POST /users', () => {
  ...
  it('creates a user and returns 201', async () => {
    mockSql([[{ id: 3, username: 'newuser', role: 'user', created_at: '2026-01-03' }]])
...
describe('DELETE /users/:id', () => {
  ...
  it('deletes a user and returns it', async () => {
    mockSql([[{ id: 2, username: 'app', role: 'admin', created_at: '2026-01-02' }]])
